...
sudo snap install microk8s --classic --channel=1.28-strict/stable
...
cd $HOME
git clone --branch cambios23_20abril2024 https://github.com/danielbernalb/aireciudadano-cloud.git
